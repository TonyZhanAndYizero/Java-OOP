...
public class Calculator extends JFrame {
    public Calculator() {
        initComponents();
        ImageIcon icon=new ImageIcon("src/img/icon.png"); //图片和项目同一路径，故不用图片的路径
    ...
    private void initComponents() {
        ...
        button1.setBounds(40, 281, 85, 40);
        ...
        button2.setBounds(130, 281, 85, 40);
        ...
        button3.setBounds(220, 281, 85, 40);
        ...
        button0.setBounds(130, 327, 85, 40);
        ...
        button_dot.setBounds(220, 327, 85, 40);
        ...
        button_polar.setBounds(40, 327, 85, 40);
        ...
        button_equal.setBounds(310, 327, 85, 40);
        ...
        button_plus.setBounds(310, 281, 85, 40);
        ...
        button_smoke.setIcon(new ImageIcon(getClass().getResource("/img/smoke.png")));
        ...
        button_David.setIcon(new ImageIcon(getClass().getResource("/img/David.png")));
        ...
        button_backspace.setIcon(new ImageIcon(getClass().getResource("/img/Backspace(1)(1).png")));
